...
public class ObjectFactory {
    ...
    private final static QName _CloudFract_QNAME = new QName("http://aber.ac.uk/simsphere", "CloudFract");
    private final static QName _ObstacleHeight_QNAME = new QName("http://aber.ac.uk/simsphere", "ObstacleHeight");
    private final static QName _UseCloudCover_QNAME = new QName("http://aber.ac.uk/simsphere", "UseCloudCover");
    ...
    /**
     * Create an instance of {@link VegCommon.FoliageEmissivity }
     * 
     */
    public VegCommon.FoliageEmissivity createVegCommonFoliageEmissivity() {
        return new VegCommon.FoliageEmissivity();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aber.ac.uk/simsphere", name = "CloudFract")
    public JAXBElement<Float> createCloudFract(Float value) {
        return new JAXBElement<Float>(_CloudFract_QNAME, Float.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aber.ac.uk/simsphere", name = "UseCloudCover")
    public JAXBElement<Boolean> createUseCloudCover(Boolean value) {
        return new JAXBElement<Boolean>(_UseCloudCover_QNAME, Boolean.class, null, value);
    }
